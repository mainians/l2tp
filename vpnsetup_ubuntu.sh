...
install_vpn_pkgs() {
  ...
  (
    set -x
    apt -yqq install libnss3-dev libnspr4-dev pkg-config \
...
get_ikev2_script() {
  ...
  ikev2_url="https://cdn.jsdelivr.net/gh/mainians/l2tp@main/extras/ikev2setup.sh"
  (
    set -x
...
get_libreswan() {
  if ! check_libreswan; then
    ...
    swan_url1="https://cdn.jsdelivr.net/gh/mainians/l2tp@main/v$SWAN_VER.tar.gz"
